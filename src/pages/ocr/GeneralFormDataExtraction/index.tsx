...
const GeneralFormDataExtraction = () => {
  ...
  return (
    <>
      <Group align="initial" style={{ padding: "50px" }}>
        <Stack style={{ flex: "1" }}>
          <Text size="40" inline>
            <b>Extração de dados em formato de formulário</b>
          </Text>
          <Text size="24" inline>
            Essa era a primeira versão com a qual vcs estavam fazendo os testes.
            Esse modelo tenta buscar no documento campos que possam ser
            relacionados em alguma chave-valor.
          </Text>
          <Text size="24" inline>
            Por isso acabava omitindo um dado que tivesse detectado caso não
            tivesse relacionado ele com alguma chave, ou acabava confundindo e
            relacionando um dado com uma outra chave qualquer.{" "}
            <a
...
export default GeneralFormDataExtraction;
